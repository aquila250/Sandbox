...
echo ">>> NOTE: This script Has been Modified For a specific use case."
echo ">>>       Make sure this is still what you want !!!"
echo ""; echo ">>> MAKE SURE !!! You are in the right directory?"
pwd; ls -FA
echo ""; echo ">>> Enter INPUT file type :"; echo "eg: [mp3], [m4a], [flac]"
read input
clear
: ' modified For quick work
echo ""; echo ">>> Enter OUTPUT file type :"; echo "eg: [flac]"
read output
'
echo ">>> NOTE: OUTPUT file type set to [flac]. Change if needed."; sleep 2
output="flac"
